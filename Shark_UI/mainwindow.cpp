...
MainWindow::MainWindow(std::shared_ptr<ClientSession> sessionPtr, QWidget *parent)
  ...
  connect(ui->loginPage, &loginScreen::registrationRequested, this, &MainWindow::setRegistrationForm);
  connect(ui->loginPage, &loginScreen::rejected, this, &MainWindow::onRejectedRequested);
  connect(ui->loginPage, &loginScreen::accepted, this, &MainWindow::onLoggedIn);

  connect(ui->regPage, &registerScreen::loginRequested, this, &MainWindow::setLoginForm);
  connect(ui->regPage, &registerScreen::rejected, this, &MainWindow::onRejectedRequested);
...
void MainWindow::setLoginForm()
{
  ...
  QWidget* page = ui->mainWindowstackedWidget->findChild<QWidget*>("loginPage");
