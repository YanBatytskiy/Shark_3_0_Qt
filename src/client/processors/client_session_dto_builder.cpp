...
ClientSessionDtoBuilder::ClientSessionDtoBuilder(ClientCore &core) : core_(core) {}
...
std::optional<ChatDTO> ClientSessionDtoBuilder::fillChatDTOCl(const std::shared_ptr<Chat> &chat_ptr) {
  ChatDTO chat_dto;
