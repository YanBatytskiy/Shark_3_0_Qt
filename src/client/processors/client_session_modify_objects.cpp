...
ClientSessionModifyObjects::ClientSessionModifyObjects(ClientSession &session) : _session(session) {}
...
bool ClientSessionModifyObjects::changeUserDataCl(const UserDTO &user_dto) {
  ...
  packet_list_result = _session.processingRequestToServer(packet_list_send, packet_dto.requestType);
